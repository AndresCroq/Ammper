  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          <svg width={50} fill='none' height={30} viewBox='0 0 268 150' xmlns='http://www.w3.org/5000/svg'>
            <image xlinkHref='/images/logos/cropped-ammper.png' height={200} fill='white' />
          </svg>

          <HeaderTitle variant='h6' sx={{ ...menuCollapsedStyles, ...(navCollapsed && !navHover ? {} : { ml: 2 }) }}>
            <img style={{ marginTop: '12px' }} height={'30px'} src='/images/logos/ammper-logo.png' alt='' />
          </HeaderTitle>
        </LinkStyled>
      )}
